...
register(
    ...
    entry_point='envs.gridworld.minigrid.gym_minigrid.envs:LavaGapS5Env'
)

register(
    id='MiniGrid-LavaGapS6-v0',
    entry_point='envs.gridworld.minigrid.gym_minigrid.envs:LavaGapS6Env'
)

register(
    id='MiniGrid-LavaGapS7-v0',
    entry_point='envs.gridworld.minigrid.gym_minigrid.envs:LavaGapS7Env'
)

register(
    id='MiniGrid-LavaGapS8-v0',
    entry_point='envs.gridworld.minigrid.gym_minigrid.envs:LavaGapS8Env'
)

register(
    id='MiniGrid-LavaGapS9-v0',
    entry_point='envs.gridworld.minigrid.gym_minigrid.envs:LavaGapS9Env'
)
