...
register(
    ...
    entry_point='nvs.gridworld.minigrid.minigrid.gym_minigrid.envs:TigerDoorEnvOSC_1'
)

register(
    id='MiniGrid-TigerDoorEnvOSC-v2',
    entry_point='envs.gridworld.minigrid.gym_minigrid.envs:TigerDoorEnvOSC_2'
)

register(
    id='MiniGrid-TigerDoorEnvOSC-v3',
    entry_point='envs.gridworld.minigrid.gym_minigrid.envs:TigerDoorEnvOSC_3'
)
